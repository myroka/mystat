...
public:
    ...
    // вывод менюшки под выбор вкладки
    void ShowMenu()
    {
    ...
    void otziv() {
        cout << "\nОтзывы:\n";
        cout << "1 Шевченко Денис Сергійович, Python ШС"
            "Мирослав, крутий початок, завжди активний на занятті, але не намагайся десь схалтурити", 
            "адже тобі важливо отримувати власні знання)"
            "Круто розвинена логіка, що дозволяє вибудовувати процес алгоритмізації коду, так тримати!\n";
        cout << "2 Помогает организовать учебу, рекомендую.\n";
        cout << "3 Есть недостатки, но в целом полезно.\n";
        cout << "4 Понравился интерфейс, всё понятно и просто.\n";
        cout << "5 Хороший инструмент для студентов.\n";
    }
};
